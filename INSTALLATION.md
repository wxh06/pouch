...
``` bash
curl -fsSL https://mirrors.aliyun.com/opsx/pouch/linux/debian/opsx@service.alibaba.com.gpg.key | sudo apt-key add -
```
...
``` bash
sudo add-apt-repository "deb https://mirrors.aliyun.com/opsx/pouch/linux/debian/ pouch stable"
```
